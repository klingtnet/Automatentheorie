...
\begin{enumerate}[(a)]
    \item $S = (\mathbb{Z}, +, \cdot, 0, 1)$, mit $s(w) = 2|w|_a -3|w|_b + 4|w|_c$
      ...
      $1 \cdot \left(2.a + \left(-3\right).b + 4.b\right) \cdot 1$ beschreibt $s$.
    ...
    \item $S = (\mathcal{P}(A^*), \cup, \cdot, \varnothing, \{\varepsilon\})$ mit
      ...
      $\left(\left(a.a\right)^+ \cdot \left(1.b\right) \cdot 1\right) \cup \left(\left(aa.a\right)^+ \cdot \left(1.b\right) \cdot 1\right)$ beschreibt s.
